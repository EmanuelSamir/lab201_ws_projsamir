...
def motion_sinpercycle(freq, start_time):
	joint_pos_desired = 0.6*np.sin(freq*(time.time() - start_time)) 
...
if __name__ == '__main__':
	...
	joint7_en = False
	amplitude = 0.1
	DIRECTORY = '../data/sawyer/temp/'#vel_sin_motion_incrf/test_joint4/'#sin_motion/test_joint1/'
	FILENAME = DIRECTORY + 'test_0.csv'
