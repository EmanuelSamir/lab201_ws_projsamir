...
def motion_sinpercycle(freq, start_time):
	joint_pos_desired = 0.9*np.sin(freq*(time.time() - start_time))# + np.random.randn(1)*0.1
	return joint_pos_desired


def random_frequency_sat(saturation_min = 0.49, saturation_max = 0.5):
...
if __name__ == '__main__':
	...
	FILENAME = DIRECTORY + 'training_data.csv'
